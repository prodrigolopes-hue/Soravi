// Blocklist de senhas comuns da Soravi.
//
// Fonte: SecLists (danielmiessler/SecLists), MIT License.
// Ver ATTRIBUTION.md neste diretório para detalhes completos de
// proveniência, commit SHA e regra de seleção. Não editar manualmente:
// regenerar a partir da fonte descrita em ATTRIBUTION.md.
//
// Quantidade de entradas: 3000.

export const SORAVI_COMMON_PASSWORDS_BLOCKLIST: readonly string[] = [
  "123qweasdzxc",
  "1qaz2wsx3edc",
  "q1w2e3r4t5y6",
  "1q2w3e4r5t6y",
